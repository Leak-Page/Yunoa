...
-- Créer un index unique composé pour éviter les doublons de vues par jour
CREATE INDEX idx_user_video_views_unique_daily 
ON public.user_video_views (user_id, video_id, date(viewed_at));
